...
const { priceUSD: rikoPriceUSD } = require('./riko');
...
module.exports = {
    ...
    async pool({block = undefined, timestamp = undefined, pool_id = undefined, pool_address = undefined} = {}) {
        if(!pool_id && !pool_address) { throw new Error("patswap-data: Pool ID / Address undefined"); }
    ...
    async stakedValue({block = undefined, timestamp = undefined, token_address = undefined} = {}) {
        if(!token_address) { throw new Error("patswap-data: Token address undefined"); }
    ...
    async apys({block = undefined, timestamp = undefined} = {}) {
        ...
        const rikoUSD = await sushiPriceUSD({block, timestamp});
